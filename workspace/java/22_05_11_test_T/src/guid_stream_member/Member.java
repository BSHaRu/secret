...
public class Member implements Serializable, Comparable<Member> { // Comparable : 기존값과 자기자신을 비교해줌
	
	private static final long serialVersionUID = 5794708333528345910L;
	...
	public String getReg() {
		...
		Date date = new Date(this.reg); // java.util.Date
	...
	public boolean equals(Object o) {
		if(o instanceof Member) {
			Member m = (Member)o; // obj 타입을 Member타입으로 변경
			if(this.mId.equals(m.getmId()) && this.mPw.equals(m.getmPw()) ) return true;
		}
		return false;
	}
